    ...
    <Box>
      <Flex p="6" direction="column" gap="2">
        ...
        <Tabs.Root defaultValue="messages">
          ...
          <Flex pt="4" gap="2">
            <Tabs.Content value="messages" asChild>
            ...
            <Tabs.Content value="content" asChild>
              <Box width="100%">

                <Grid columns="3" gap="2">

                  <AspectRatio ratio={1}>
                    <img src="/atoll.png" alt="atoll" style={{
                      objectFit: "cover",
                      width: "100%",
                      height: "100%",
                    }} />
                  ...
                  <AspectRatio ratio={1}>
                    <img src="/beach.jpg" alt="beach" style={{
                      objectFit: "cover",
                      width: "100%",
                      height: "100%",
                    }} />
                  ...
                  <AspectRatio ratio={1}>
                    <img src="/cabin.jpg" alt="cabin" style={{
                      objectFit: "cover",
                      width: "100%",
                      height: "100%",
                    }} />
                  ...
                  <AspectRatio ratio={1}>
                    <img src="/canyon.jpg" alt="canyon" style={{
                      objectFit: "cover",
                      width: "100%",
                      height: "100%",
                    }} />
                  ...
                  <AspectRatio ratio={1}>
                    <img src="/city.png" alt="city" style={{
                      objectFit: "cover",
                      width: "100%",
                      height: "100%",
                    }} />
                  ...
                  <AspectRatio ratio={1}>
                    <img src="/field.png" alt="field" style={{
                      objectFit: "cover",
                      width: "100%",
                      height: "100%",
                    }} />
                  ...
                  <AspectRatio ratio={1}>
                    <img src="/forest.jpg" alt="forest" style={{
                      objectFit: "cover",
                      width: "100%",
                      height: "100%",
                    }} />
                  ...
                  <AspectRatio ratio={1}>
                    <img src="/lake.jpg" alt="lake" style={{
                      objectFit: "cover",
                      width: "100%",
                      height: "100%",
                    }} />
                  ...
                  <AspectRatio ratio={1}>
                    <img src="/mist.png" alt="mist" style={{
                      objectFit: "cover",
                      width: "100%",
                      height: "100%",
                    }} />
            ...
            <Tabs.Content value="favourites" asChild>
              <Box width="100%">
                <Callout.Root>
                  <Callout.Icon>
                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function GroupDialog() {
  return (
    <Dialog.Root>
      <Dialog.Trigger>
        <Button variant="soft">Add to group</Button>
      </Dialog.Trigger>

      <Dialog.Content style={{ maxWidth: 450 }}>
        <Dialog.Title>Add to group</Dialog.Title>
        <Dialog.Description size="2" mb="4">
          Add user to a custom user group.
        </Dialog.Description>
